#!/bin/bash
# Normal Voltage 고온(80°C) 데이터만 재수집하는 스크립트

set -e

echo "========================================"
echo "Normal Voltage 고온 데이터 재수집 (80°C)"
echo "========================================"
echo ""
echo "이 스크립트는 Normal Voltage 고온(80°C) 데이터만 수집합니다:"
...
echo ""
echo "========================================"
echo "Normal Voltage - Hot Temperature (80°C)"
echo "========================================"
echo ""
...
echo ""
echo "========================================"
echo "Normal Voltage 고온 데이터 수집 완료!"
echo "========================================"
echo ""
echo "수집된 파일:"
