...
# Benign Experiments - Low Voltage
# 1. Benign + LowVolt
# 2. Benign + Hot + LowVolt

set -e

echo "========================================"
echo "Benign Experiments (Low Voltage)"
echo "========================================"
echo ""
...
echo "  1. Benign + LowVolt"
echo "  2. Benign + Hot + LowVolt"
echo ""
...
echo ""
echo "[1/2] Benign + LowVolt"
python3 collect_benign.py "Benign_LowVolt" "${RESULT_DIR}/benign_lowvolt.csv"
cooldown 180

echo ""
echo "[2/2] Benign + Hot + LowVolt"
python3 collect_benign.py "Benign_Hot_LowVolt" "${RESULT_DIR}/benign_hot_lowvolt.csv" --hot
cooldown 180
...
echo "Complete!"
echo "========================================"
ls -lh "$RESULT_DIR"/benign_*lowvolt.csv
echo ""
for file in "$RESULT_DIR"/benign_*lowvolt.csv; do
    FLIPS=$(awk -F',' 'NR>1 {sum+=$9} END {print sum}' "$file")
    echo "$(basename $file): $FLIPS flips"
done
echo ""
echo "[+] Benign (Low Voltage) complete!"
echo "[*] Next: sudo ./run_6_idle_lowvolt.sh"
